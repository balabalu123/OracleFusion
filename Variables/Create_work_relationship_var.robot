...
${txt_username}              //input[@placeholder='User ID']
...
#payroll_detailsxpath://span[text()='Payroll Details']
#salaryxpath://span[text()='Salary']
#compensationxpath://span[text()='Compensation']
#add_direct_reports"xpath://span[text()='Add Direct Reports']
#comments_and_attachmentsxpath://span[text()='Comments and Attachments']
...
${Ok_nationa}                             xpath:(//span[@class='xri'])[5]
